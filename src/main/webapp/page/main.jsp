 ...
 <div class="mail-box">
                  <aside class="sm-side">
                      <div class="user-head">
                          <a class="inbox-avatar" href="javascript:;">
                              <img  width="64" hieght="60" src="../imgs/mzd.jpg">
                          </a>
                          <div class="user-name">
                              <h5><a href="page_init()">毛超杰</a></h5>
                      ...
                      <ul class="inbox-nav inbox-divider">
                          <li class="active">
                              <a href="main.jsp"><i class="fa fa-inbox"></i>用户信息<span class="label label-danger pull-right">2</span></a>

                          </li>
                          <li>
                              <a href="statementOfBill.jsp"><i class="fa fa-envelope-o"></i>收入支出信息</a>
                          </li>
                          <li>
                  ...
                  <aside class="lg-side">
                      <div class="inbox-head">
                          <h3>我的小管家</h3>
                          <div style="float:right;color:red"><span>[<a id="loginOut" herf="loginOut.html" style="color:black">切换用户</a>]</span>&emsp;<span>[<a style="color:black">注销</a>]</span></div>
		...
		$("#dataTable").datagrid({
			...
			pagination : true,
			 columns:[[    
	    	        ...
	    	        {field:'tel',title:'手机号',width:120,align:'center'},
